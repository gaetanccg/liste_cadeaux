...
const gifts = ref([
  {
    ...
    prix: 90,
    description: 'Je trouve les bracelets en bois et pierre naturelle de chez Holzkern magnifiques, j\'aimerais beaucoup en avoir un !',
...
<template>
  <header class="hero">
    <h1 class="title glitch" data-text="Liste secrète 🎅">
      Liste secrète 🎅
    </h1>
    <p class="subtitle">Pour les initiés seulement 😏</p>
  </header>
